...
function post_comment($comment, $user_id, $task_id) {
	$query = mysql_query("INSERT INTO `taskcomments`(`taskid`, `userid`, `comment`, `comment_time`) VALUES ('$task_id', '$user_id', '$comment', now())");
	if ($query) {
		return true;
	} else {
		return false;	
